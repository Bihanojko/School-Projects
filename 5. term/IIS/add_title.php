...
<html>
    <head>
        ...
        <script>
            function check_add_title()
            {
                ...
                if (document.getElementById("kniha").checked)
                {
    ...
    <body>
        ...
        <h2 align="center">Vložení titulu</h2><br>

        <?php if (isset($_SESSION['error']) && $_SESSION['error'] == '1'): ?>
        <br>
        <div align="center" role="alert"><strong>Chyba při vládání titulu, titul se již nachází v databázi.</strong></div><br>
        <?php unset($_SESSION['error']);
        elseif (isset($_SESSION['error']) && $_SESSION['error'] == '0'): ?>
        <br>
        <div align="center" role="alert"><strong>Titul byl úspěšně vložen.</strong></div><br>
        <?php unset($_SESSION['error']);
        endif; ?>

        <form action="insert_title.php" method="POST">              <!-- TODO check if all * fields inserted and check values -->
        <table align="center">
        <tr>
            <td>Název: </td>
            <td><input type="text" name="title" maxlength="50" id="nazev" oninput="check_add_title()"> *</td>
        </tr><tr>
            <td>Jméno autora: </td>
            <td><input type="text" name="aname" maxlength="50" id="jmeno" oninput="check_add_title()"> *</td>
        </tr><tr>
            <td>Příjmení autora: </td>
            <td><input type="text" name="asurname" maxlength="50" id="prijmeni" oninput="check_add_title()"> *</td>
        </tr>
        </tr><tr>
            <td>Jazyk: </td>
            <td><input type="text" name="language" maxlength="20" id="jazyk" oninput="check_add_title()"></td>
        </tr><tr>
            <td>Žánr: </td>
            <td><input type="text" name="genre" maxlength="20" id="zanr" oninput="check_add_title()"></td>
        </tr><tr>
            <td>Typ: </td>
            <td><input type="radio" name="type" value="kniha" id="kniha" oninput="check_add_title()" checked> Kniha
            <input type="radio" name="type" value="casopis" id="casopis" oninput="check_add_title()"> Časopis</td>
        </tr><tr>
            <td>ISBN / ISSN: </td>
            <td><input type="text" name="isbnissn" maxlength="13"  id="isbn_issn" oninput="check_add_title()"></td>
        </tr><tr>
            <td> </td>
            <td>* povinná pole</td>
        </tr>
        ...
        <br>
        <input type="submit" value="Přidat titul" id="submit" disabled>
        </form>
    <br>
    </body>
</html> 